...
{
    struct cwc_tag_info *tag  = req->u.activate.workspace->data;
    struct cwc_output *output = req->u.deactivate.workspace->group->data;
...
{
    struct cwc_tag_info *tag  = req->u.deactivate.workspace->data;
    struct cwc_output *output = req->u.deactivate.workspace->group->data;
...
{
    struct cwc_tag_info *tag = req->u.remove.workspace->data;
